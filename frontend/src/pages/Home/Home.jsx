  ...
  return (
    <>
      ...
      <div className={styles.lowerSection}>
        <div className={styles.lp1}>Welcome to HealthDoc</div>
        <div className={styles.lp2}>
          An AI Powered Platform for Managing Health Records
        </div>
        <div className={styles.lp3}>
          Discover a better way to manage your health records. HealthDoc helps
        ...
        <div className={styles.lp6}>
          A passion of putting patients first
        </div>
        <div className={styles.lp7}>
          <ul>
            <li>Personalized Virtual Assistant</li>
