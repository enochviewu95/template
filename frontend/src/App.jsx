...
import Manage_doctors from "./components/ManageDoctors/ManageDoctors";
import Manage_patients from "./components/ManagePatients/ManagePatients";
import Add_report from "./pages/AddReport/AddReport";
import Appointment from "./pages/Appointment/Appointment";
import Current_Prescription from "./pages/Doctor/CurrentPrescription/CurrentPrescription";
import Test_Report from "./pages/Doctor/TestReport/TestReport";
import Patient_Health_History from "./pages/Doctor/PatientHealthHistory/PatientHealthHistory";
import Patient_Appointment from "./pages/Doctor/PatientAppointment/PatientAppointment";
